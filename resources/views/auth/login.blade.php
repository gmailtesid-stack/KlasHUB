    ...
    <div class="w-full max-w-sm">
        <div class="text-center mb-10">
            <div class="w-56 h-56 mx-auto flex items-center justify-center mb-2 overflow-hidden">
                <img src="{{ asset('icon.png') }}" class="w-full h-full object-contain scale-[1.8] origin-center animate-pulse" style="animation-duration: 3.5s;" alt="KelasHub Logo">
            </div>
        </div>
        ...
        <form method="POST" action="/login" class="space-y-4 bg-zinc-950 p-6 rounded-3xl border border-zinc-900">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" required placeholder="Contoh: ARIYAS PRATAMA RAMADHAN" class="w-full bg-zinc-900 border border-zinc-800 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500 text-sm transition-all placeholder-zinc-600">
            </div>

            <div>
                <label for="password" class="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-2">Password</label>
                <div class="relative">
                    <input type="password" name="password" id="password" required placeholder="••••••••" class="w-full bg-zinc-900 border border-zinc-800 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500 text-sm transition-all placeholder-zinc-600 pr-10">
                    <button type="button" id="togglePassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-zinc-500 hover:text-zinc-300">
            ...
            <button type="submit" class="w-full bg-white text-black font-bold text-sm rounded-xl px-4 py-3 hover:bg-zinc-200 transition-colors mt-2">
                Masuk ke Dashboard
            </button>
