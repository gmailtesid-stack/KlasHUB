        ...
        init() {
            ...
            fetch('/kh/api/dashboard-data')
                ...
                .then(data => {
                    ...
                    this.semuaTugas = data.semua_tugas.map(t => ({...t, matkul: t.subject_name, isValidated: t.is_validated}));
                    this.semuaModul = data.semua_modul.map(m => ({...m, matkul: m.subject_name, isValidated: m.is_validated}));
                ...
                <div class="max-w-5xl mx-auto w-full h-full">
                    ...
                    <div x-show="tab === 'presensi'" x-transition:enter="transition ease-out duration-300"
                        ...
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                            ...
                            @if(!in_array($student->role ?? '', ['super_admin']))
                        ...
                        @if(in_array($student->role ?? '', ['ketua_kelas', 'sekretaris', 'super_admin']))
